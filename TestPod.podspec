...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/prapawity/TestPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'prapawity' => 'protfc16@gmail.com' }
  s.source           = { :git => 'https://github.com/prapawity/TestPod.git', :tag => s.version.to_s }
